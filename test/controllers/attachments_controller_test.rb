...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post attachments_url, params: { attachment: { essay_id: @attachment.essay_id, name: @attachment.name, url: @attachment.url } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { essay_id: @attachment.essay_id, name: @attachment.name, url: @attachment.url } }
