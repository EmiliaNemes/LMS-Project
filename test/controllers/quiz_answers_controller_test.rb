...
class QuizAnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quiz_answer" do
    assert_difference('QuizAnswer.count') do
      post quiz_answers_url, params: { quiz_answer: { answer: @quiz_answer.answer, is_correct: @quiz_answer.is_correct, question_id: @quiz_answer.question_id } }
    end
  ...
  test "should update quiz_answer" do
    patch quiz_answer_url(@quiz_answer), params: { quiz_answer: { answer: @quiz_answer.answer, is_correct: @quiz_answer.is_correct, question_id: @quiz_answer.question_id } }
